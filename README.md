...
|---|---|---|---|
| **Wall** | projector, whole room | `/wall` | An isometric HAVEN-9: six lit districts around the Geothermal Core, each with a compact integrity marker and warning badges (fault clock, low stock, injured) that appear only when something is wrong · HUD with CITY · CORE · NEXT CYCLE · one most-urgent fault line · one temporary notification at a time · Council, emergency and core-drop takeovers · paused · Round 3 vs Aftershock. Healthy districts are simply lit; nothing says "no faults" |
