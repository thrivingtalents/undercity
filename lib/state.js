...
class GameState {
  ...
  restore(snapshot) {
    ...
    for (const code of Object.keys(this.state.sectors)) {
      if (!this.state.broadcast.rows[code]) this.state.broadcast.rows[code] = { power: null, water: null, med: null, parts: null, status: null, round: null };
  ...
  emptyBroadcast() {
    ...
    for (const code of Object.keys(this.state ? this.state.sectors : {})) {
      rows[code] = { power: null, water: null, med: null, parts: null, status: null, round: null };
    }
