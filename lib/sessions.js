...
class SessionRegistry {
  constructor({ store, content, rounds, dataDir, scenarios = null }) {
    this.store = store;
    this.content = content;
    this.rounds = rounds;
    this.dataDir = dataDir;
    // The scenario library: a session's chosen scenario is resolved through
    // it on load and on RESET RUN WITH SCENARIO. Without it every run would
