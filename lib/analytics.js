...
function emptyRound(id) {
  return {
    ...
    rewards: { applied: 0, duplicates_blocked: 0, force_skipped: 0, overrides: 0, rvu: 0, health_points: 0, resources: {}, archetypes: {}, fallbacks: 0, resource_units_generated: 0, list: [] },
