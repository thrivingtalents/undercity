...
function envelope(game, extra, { facilitator = false } = {}) {
  ...
  return {
    ...
    mode: st.mode,
    // CONTINUOUS GAMEFLOW (2026-09-21): a participant screen is told the time
    // and the operating cycle, never the phase or the round. Those are backend
    // pacing markers and they go to the facilitator alone, below.
    ...
    ...(facilitator ? {
      ...
      phase_hint: phase ? phase.hint : null,
      round: st.round,
